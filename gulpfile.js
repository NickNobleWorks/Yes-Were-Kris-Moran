 ...
 * Scripts: Vendors
 *
 * Look at src/js and concatenate those files, send them to js where we then minimize the concatenated file.
*/
gulp.task('vendorsJs', function() {
  return  gulp.src(['./js/vendor/*.js', bower+'**/*.js'])
...
gulp.task('buildImages', function() {
  return  gulp.src(['img/**/*', '!images/raw/**'])
